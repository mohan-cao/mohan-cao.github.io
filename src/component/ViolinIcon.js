...
const violinIcon = ({ style }) => {
  return (
    <svg
      ...
      y="0px"
      viewBox="0 0 512 512"
      style={{ width: "3em", ...style, enableBackground: "new 0 0 512 512" }}
    >
      <g>
        <g>
          <path
            d="M317.123,371.819c-10.584-2.313-18.268-11.871-18.268-22.728c0-8.336,4.514-16.087,11.778-20.231l8.809-5.021v-52.175
